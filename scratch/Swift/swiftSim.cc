...
// "Data Center TCP (Swift)." In ACM SIGCOMM Computer Communication Review,
...
// * Swift-example-s1-r1-throughput.dat
// * Swift-example-s2-r2-throughput.dat
// * Swift-example-s3-r1-throughput.dat
// provide per-flow throughputs (in Mb/s) for each of the forty flows, summed
// over the measurement window.  The fourth file,
// * Swift-example-fairness.dat
...
// The fifth and sixth:
// * Swift-example-t1-length.dat
// * Swift-example-t2-length.dat
...
// the default results show that Swift is able to achieve high link
...
int main (int argc, char *argv[]) {
  ...
  // Triumph and Scorpion switches used in Swift Paper have 4 MB of buffer
  // If every packet is 1500 bytes, 2666 packets can be stored in 4 MB
  Config::SetDefault ("ns3::RedQueueDisc::MaxSize", QueueSizeValue (QueueSize ("2666p")));
  // Swift tracks instantaneous queue length only; so set QW = 1
  ...
  // MinTh = 50, MaxTh = 150 recommended in ACM SIGCOMM 2010 Swift Paper
  ...
  // MinTh = 20, MaxTh = 60 recommended in ACM SIGCOMM 2010 Swift Paper
