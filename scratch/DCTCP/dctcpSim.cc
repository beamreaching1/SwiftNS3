...
int main (int argc, char *argv[])
{
  ...
  txS1R1RttS.open ("./scratch/DCTCP/dctcp-S1R1-rtt.dat", std::ios::out);
  txS1R1RttS << "Time(s) RTT(ms)" << std::endl;
  
  txS2R2RttS.open ("./scratch/DCTCP/dctcp-S2R2-rtt.dat", std::ios::out);
  txS2R2RttS << "Time(s) RTT(ms)" << std::endl;
  
  txS3R1RttS.open ("./scratch/DCTCP/dctcp-S3R1-rtt.dat", std::ios::out);
  txS3R1RttS << "Time(s) RTT(ms)" << std::endl;

  rxS1R1Throughput.open ("./scratch/DCTCP/dctcp-S1R1-throughput.dat", std::ios::out);
  rxS1R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
  rxS2R2Throughput.open ("./scratch/DCTCP/dctcp-S2R2-throughput.dat", std::ios::out);
  rxS2R2Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
  rxS3R1Throughput.open ("./scratch/DCTCP/dctcp-S3R1-throughput.dat", std::ios::out);
  rxS3R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
  fairnessIndex.open ("./scratch/DCTCP/dctcp-fairness.dat", std::ios::out);
  t1QueueLength.open ("./scratch/DCTCP/dctcp-t1-length.dat", std::ios::out);
  t1QueueLength << "#Time(s) qlen(pkts) qlen(us)" << std::endl;
  t2QueueLength.open ("./scratch/DCTCP/dctcp-t2-length.dat", std::ios::out);
